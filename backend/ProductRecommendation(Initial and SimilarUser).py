...
print(list(top_n_products(final_rating, 15, 5)))
print("10 USERS SIMILAR TO USER (ID=3) BASED ON RATINGS")
print(similar_users(3, final_ratings_matrix)[0][0:10])
print("5 RECOMMENDATIONS TO USER (ID=9) BASED ON SIMILAR USERS")
print(recommendations(9, 5, final_ratings_matrix))
